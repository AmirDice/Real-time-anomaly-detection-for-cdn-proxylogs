# Data Preprocessing of CDN Dataset
...
def split_save(data):
  ...
  train.to_csv(f"./data/CDN_train.csv", sep = ',', encoding = 'utf-8', index = False)
  test.to_csv(f"./data/CDN_test.csv", sep = ',', encoding = 'utf-8', index = False)
